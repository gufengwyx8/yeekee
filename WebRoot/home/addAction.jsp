...
<head>
	<base href="<%=basePath%>" />
	    ...
	    <title>益客网-添加活动--<s:property value="user.nickName" /></title>
...
<center>
  ...
  <div class="main2">
    <div class="left">
      ...
      <div class="left2">
        <div id="l21">
          <div class="xierizhi">发布活动</div>
          
          <div class="xingm"><s:property value="user.nickName"/>的任务</div>
        </div>
         <form action="home/addAction" method="post">
        <div id="l22">
        ...
        <div class="llr">
          ...
          <div id="form4">
            <label> 开始时间
              <input type="text" name="news.startDate" id="textfield" onFocus="calendar()" />
              </label>
            <label>结束时间
            <input type="text" name="news.endDate" id="textfield2" onFocus="calendar()" />
            </label>
          </div>
          </div>
        ...
        <div class="niu">
            ...
            <input type="button" name="baocun" id="baocun" value="保存草稿" />
              </label>
            <label>
